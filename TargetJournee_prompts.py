liste_des_taches_de_la_journee = """
...
Ignore all statements starting with //
				...
				Destinataire : Mon cher [NOM DE LINTERLOCUTEUR]
				Objet du mail : [FAIRE UNE PROPOSITION EN FONCTION DU NOM DU CLIENT ET TARGETS DE LA JOURNEE]
				Style decriture : Professionnel et bienveillant
				Autres détails : Penser à le remercier pour sa disponibilité
				
				Use French language : Francais

Now i will give you the request : {LISTE_DES_TACHES}."""
